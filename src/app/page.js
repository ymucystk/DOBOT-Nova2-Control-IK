...
export default function Home() {
  ...
  const joint_pos = {
    base:{x:0,y:0,z:0},
    j1:{x:0,y:0,z:0},
    j2:{x:0,y:0.22291,z:0},
    j3:{x:0,y:0.28,z:0},
    j4:{x:0,y:0.225,z:0},
    j5:{x:0.11701,y:0.11951,z:0},
    j6:{x:0,y:0,z:0},
    j7:{x:0,y:0,z:0.1},
  }
...
const Assets = ()=>{
  return (
    <a-assets>
      {/*Model*/}
      <a-asset-items id="base" src="NOVA2_BASE_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j1" src="NOVA2_J1_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="NOVA2_J2_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="NOVA2_J3_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="NOVA2_J4_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="NOVA2_J5_ASM.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="NOVA2_J6_ASM.gltf" ></a-asset-items>
    </a-assets>
  )
}
